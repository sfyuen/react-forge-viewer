...
/* harmony import */ var _emotion_cache__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5513);
/* harmony import */ var _emotion_serialize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2830);
...
/* harmony import */ var _emotion_element_43c6fea0_browser_esm_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5756);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5043);
/* harmony import */ var _emotion_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1722);
/* harmony import */ var _emotion_use_insertion_effect_with_fallbacks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9436);
/* harmony import */ var _emotion_serialize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2830);
/* harmony import */ var _emotion_cache__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5513);
/* harmony import */ var hoist_non_react_statics__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(219);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5043);
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3290);
...
var emotion_element_43c6fea0_browser_esm = __webpack_require__(5756);
...
var emotion_serialize_browser_esm = __webpack_require__(2830);
...
var emotion_react_browser_esm = __webpack_require__(3290);
// EXTERNAL MODULE: ./node_modules/@emotion/cache/dist/emotion-cache.browser.esm.js + 7 modules
var emotion_cache_browser_esm = __webpack_require__(5513);
...
var GlobalStyles = __webpack_require__(869);
...
var _formatMuiErrorMessage2 = _interopRequireDefault(__webpack_require__(7245));
var _clamp = _interopRequireDefault(__webpack_require__(1098));
...
var _styledEngine = _interopRequireWildcard(__webpack_require__(3174));
var _deepmerge = __webpack_require__(4534);
var _capitalize = _interopRequireDefault(__webpack_require__(578));
var _getDisplayName = _interopRequireDefault(__webpack_require__(2046));
var _createTheme = _interopRequireDefault(__webpack_require__(4989));
var _styleFunctionSx = _interopRequireDefault(__webpack_require__(3234));
...
var deepmerge = __webpack_require__(3216);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/createTheme/createBreakpoints.js
var createBreakpoints = __webpack_require__(4853);
...
var esm_spacing = __webpack_require__(8604);
...
/* harmony export */ });
/* harmony import */ var _createTheme__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8280);
/* harmony import */ var _createBreakpoints__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4853);
/* harmony import */ var _applyStyles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9703);
...
/* harmony export */ });
/* harmony import */ var _mui_utils_deepmerge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3216);
...
var breakpoints = __webpack_require__(9751);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/style.js
var style = __webpack_require__(7162);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/merge.js
var merge = __webpack_require__(3815);
...
/* harmony export */ });
/* harmony import */ var _mui_utils_capitalize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(410);
/* harmony import */ var _breakpoints__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9751);
...
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/spacing.js + 1 modules
var spacing = __webpack_require__(8604);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/style.js
var style = __webpack_require__(7162);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/merge.js
var merge = __webpack_require__(3815);
...
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8587);
/* harmony import */ var _mui_utils_deepmerge__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3216);
/* harmony import */ var _defaultSxConfig__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7758);
...
/* harmony export */ });
/* harmony import */ var _styleFunctionSx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8812);
/* harmony import */ var _extendSxProp__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8698);
/* harmony import */ var _defaultSxConfig__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7758);
...
/* harmony export */ });
/* harmony import */ var _mui_utils_capitalize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(410);
/* harmony import */ var _merge__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3815);
/* harmony import */ var _style__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7162);
/* harmony import */ var _breakpoints__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9751);
/* harmony import */ var _defaultSxConfig__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7758);
...
function unstable_createStyleFunctionSx() {
  function getThemeValue(prop, val, theme, config) {
    ...
    const styleFromPropValue = propValueFinal => {
      ...
      if (propValueFinal === value && typeof propValueFinal === 'string') {
        // Haven't found value
        value = (0,_style__WEBPACK_IMPORTED_MODULE_0__/* .getStyleValue */ .BO)(themeMapping, transform, "".concat(prop).concat(propValueFinal === 'default' ? '' : (0,_mui_utils_capitalize__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(propValueFinal)), propValueFinal);
      }
      if (cssProperty === false) {
        return value;
      }
...
exports.A = void 0;
var React = _interopRequireWildcard(__webpack_require__(5043));
var _styledEngine = __webpack_require__(3174);
function _getRequireWildcardCache(e) {
  if ("function" != typeof WeakMap) return null;
  var r = new WeakMap(),
    t = new WeakMap();
...
/* harmony export */ });
/* harmony import */ var _mui_utils_formatMuiErrorMessage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6632);
...
/* harmony export */ });
/* harmony import */ var _capitalize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(410);
...
/* harmony export */ });
/* harmony import */ var _deepmerge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3216);
...
/* harmony export */ });
/* harmony import */ var _formatMuiErrorMessage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6632);
...
var react_is = __webpack_require__(9565);
...
if (true) {
  module.exports = __webpack_require__(8609);
} else {}
 ...
 */function initViewer(container,config){return new Promise(function(resolve,reject){Autodesk.Viewing.Initializer({getAccessToken},function(){const viewer=new window.Autodesk.Viewing.GuiViewer3D(container,config);viewer.start();resolve(viewer);});});}/**
 * Lists all models available for viewing.
 * @async
 * @returns {Promise<{ name: string, urn: string }>} List of models.
 */function listModels(){return fetch(APP_URL+'/api/models').then(resp=>resp.ok?resp.json():Promise.reject(resp));}/**
 ...
 */function loadModel(viewer,urn){Autodesk.Viewing.Document.load('urn:'+urn,doc=>viewer.loadDocumentNode(doc,doc.getRoot().getDefaultGeometry()),(code,message,errors)=>{console.error(code,message,errors);alert('Could not load model. See console for more details.');});}/* eslint-disable */
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js
var esm_extends = __webpack_require__(8168);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js
var objectWithoutPropertiesLoose = __webpack_require__(8587);
...
var styled_engine = __webpack_require__(3174);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/styleFunctionSx/styleFunctionSx.js
var styleFunctionSx = __webpack_require__(8812);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/styleFunctionSx/extendSxProp.js
var extendSxProp = __webpack_require__(8698);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/createTheme/createTheme.js + 2 modules
var createTheme = __webpack_require__(8280);
// EXTERNAL MODULE: ./node_modules/@emotion/react/dist/emotion-element-43c6fea0.browser.esm.js
var emotion_element_43c6fea0_browser_esm = __webpack_require__(5756);
...
var formatMuiErrorMessage = __webpack_require__(6632);
// EXTERNAL MODULE: ./node_modules/@mui/utils/deepmerge/deepmerge.js
var deepmerge = __webpack_require__(3216);
// EXTERNAL MODULE: ./node_modules/@mui/system/esm/styleFunctionSx/defaultSxConfig.js + 5 modules
var defaultSxConfig = __webpack_require__(7758);
...
var colorManipulator = __webpack_require__(7266);
...
var createStyled = __webpack_require__(8052);
...
var system_useThemeWithoutDefault = __webpack_require__(2374);
...
const Popper_Popper = /*#__PURE__*/react.forwardRef(function Popper(inProps, ref) {
  ...
  const {
    ...
    other = (0,objectWithoutPropertiesLoose/* default */.A)(props, Popper_Popper_excluded);
...
const Tooltip = /*#__PURE__*/react.forwardRef(function Tooltip(inProps, ref) {
  ...
  const stopTouchInteraction = utils_useEventCallback(() => {
  ...
  const childrenProps = (0,esm_extends/* default */.A)({}, nameOrDescProps, other, children.props, {
    className: dist_clsx(other.className, children.props.className),
  ...
  const popperProps = appendOwnerState(PopperComponent, (0,esm_extends/* default */.A)({}, PopperProps, (_slotProps$popper = slotProps.popper) != null ? _slotProps$popper : componentsProps.popper, {
    className: dist_clsx(classes.popper, PopperProps == null ? void 0 : PopperProps.className, (_ref6 = (_slotProps$popper2 = slotProps.popper) != null ? _slotProps$popper2 : componentsProps.popper) == null ? void 0 : _ref6.className)
  }), ownerState);
  const transitionProps = appendOwnerState(TransitionComponent, (0,esm_extends/* default */.A)({}, TransitionProps, (_slotProps$transition = slotProps.transition) != null ? _slotProps$transition : componentsProps.transition), ownerState);
  const tooltipProps = appendOwnerState(TooltipComponent, (0,esm_extends/* default */.A)({}, (_slotProps$tooltip = slotProps.tooltip) != null ? _slotProps$tooltip : componentsProps.tooltip, {
    className: dist_clsx(classes.tooltip, (_ref7 = (_slotProps$tooltip2 = slotProps.tooltip) != null ? _slotProps$tooltip2 : componentsProps.tooltip) == null ? void 0 : _ref7.className)
  }), ownerState);
  const tooltipArrowProps = appendOwnerState(ArrowComponent, (0,esm_extends/* default */.A)({}, (_slotProps$arrow = slotProps.arrow) != null ? _slotProps$arrow : componentsProps.arrow, {
    className: dist_clsx(classes.arrow, (_ref8 = (_slotProps$arrow2 = slotProps.arrow) != null ? _slotProps$arrow2 : componentsProps.arrow) == null ? void 0 : _ref8.className)
  }), ownerState);
...
const TextareaAutosize = /*#__PURE__*/react.forwardRef(function TextareaAutosize(props, forwardedRef) {
  ...
  useEnhancedEffect_useEnhancedEffect(() => {
    ...
    const debounceHandleResize = debounce_debounce(handleResize);
    const input = inputRef.current;
    const containerWindow = ownerWindow(input);
...
const InputBase_useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', "color".concat(utils_capitalize(color)), disabled && 'disabled', error && 'error', fullWidth && 'fullWidth', focused && 'focused', formControl && 'formControl', size && size !== 'medium' && "size".concat(utils_capitalize(size)), multiline && 'multiline', startAdornment && 'adornedStart', endAdornment && 'adornedEnd', hiddenLabel && 'hiddenLabel', readOnly && 'readOnly'],
...
const FormLabel_useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', "color".concat(utils_capitalize(color)), disabled && 'disabled', error && 'error', filled && 'filled', focused && 'focused', required && 'required'],
...
const InputLabel_useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', formControl && 'formControl', !disableAnimation && 'animated', shrink && 'shrink', size && size !== 'normal' && "size".concat(utils_capitalize(size)), variant],
...
const FormControl_useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', margin !== 'none' && "margin".concat(utils_capitalize(margin)), fullWidth && 'fullWidth']
  };
...
const FormControlRoot = styles_styled('div', {
  ...
  overridesResolver: (_ref, styles) => {
    ...
    return (0,esm_extends/* default */.A)({}, styles.root, styles["margin".concat(utils_capitalize(ownerState.margin))], ownerState.fullWidth && styles.fullWidth);
  }
})(_ref2 => {
  let {
    ownerState
...
const FormHelperText_useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', disabled && 'disabled', error && 'error', size && "size".concat(utils_capitalize(size)), contained && 'contained', focused && 'focused', filled && 'filled', required && 'required']
  };
...
const FormHelperTextRoot = styles_styled('p', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.root, ownerState.size && styles["size".concat(utils_capitalize(ownerState.size))], ownerState.contained && styles.contained, ownerState.filled && styles.filled];
  }
})(_ref => {
  let {
    theme,
  ...
  react.useImperativeHandle(actions, () => ({
    adjustStyleForScrollbar: (containerElement, _ref) => {
      ...
      if (containerElement.clientHeight < listRef.current.clientHeight && noExplicitWidth) {
        const scrollbarSize = "".concat(utils_getScrollbarSize(utils_ownerDocument(containerElement)), "px");
...
const NativeSelectInput_useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    icon: ['icon', "icon".concat(utils_capitalize(variant)), open && 'iconOpen', disabled && 'disabled']
  };
...
const NativeSelectIcon = styles_styled('svg', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [styles.icon, ownerState.variant && styles["icon".concat(utils_capitalize(ownerState.variant))], ownerState.open && styles.iconOpen];
  }
...
function App_App(){const Autodesk=window.Autodesk;const[viewer,setviewer]=(0,react.useState)('');const[allID,setallID]=(0,react.useState)([]);const[isButtonDisabled,setIsButtonDisabled]=(0,react.useState)(true);const[Results,setResults]=(0,react.useState)([]);/* initialize the viewer */(0,react.useEffect)(()=>{(async function(){try{const response=await initViewer(document.getElementById("forgeviewer"));loadModel(response,"dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6YXBzLWNvZGVwZW4tYmFja2VuZC8wMV9yYWNfYmFzaWNfc2FtcGxlX3Byb2plY3QucnZ0");setviewer(response);/* get instanceTree when GEOMETRY_LOADED_EVENT completed */const getinstanceTree=()=>{const instanceTree=response.model.getData().instanceTree;const rootId=instanceTree.getRootId();if(rootId){var queue=[];var alldbId=new Set();queue.push(rootId);while(queue.length>0){var node=queue.shift();alldbId.add(node);instanceTree.enumNodeChildren(node,function(childrenIds){queue.push(childrenIds);});};}setallID(alldbId);setIsButtonDisabled(false);};response.addEventListener(Autodesk.Viewing.GEOMETRY_LOADED_EVENT,getinstanceTree);return()=>{response.removeEventListener(Autodesk.Viewing.GEOMETRY_LOADED_EVENT,getinstanceTree);};}catch(e){console.error(e);}})();},[]);/* fetch the search query */function handleSearch(userinput){try{let active=true;async function fetchdata(){var searchoutput=await viewer.model.getPropertyDb().executeUserFunction(function userFunction(pdb,r){var result=[];var allID=r[0];var searchterm=String(r[1]).toLowerCase();if(searchterm){pdb.enumObjects(dbId=>{var p=pdb.getObjectProperties(dbId);for(var i=0;i<p.properties.length;i++){var disVal=String(p.properties[i].displayValue);var idx=disVal.toLowerCase().indexOf(searchterm);if(idx!==-1&&allID.has(p.dbId)){var mid=disVal.substring(idx,idx+searchterm.length);/* Truncate long suffix/prefix terms */var pre=disVal.substring(0,idx);if(pre.length>20){pre='...'+pre.slice(-20);}var suf=disVal.substring(idx+searchterm.length,disVal.length);if(suf.length>20){suf=suf.slice(0,20)+'...';}/* Only return one matching attribute/value pairs */result.push([dbId,p.name,String(p.properties[i].displayName),pre,mid,suf,disVal]);break;}}});}return result;},[allID,userinput]);/* Only update with the last async result */if(active){setResults(await searchoutput);}};fetchdata();return()=>{active=false;};}catch(e){console.error(e);}}/* function for the click event */function handleClick(e,id){if(!e.target.classList.contains('MuiTooltip-tooltip')){try{viewer.isolate(id);viewer.select(id);viewer.fitToView(id);}catch(e){console.error(e);}}}return/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"splitScreen",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"leftPane",id:"forgeviewer"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"rightPane",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"bar",children:/*#__PURE__*/(0,jsx_runtime.jsx)(TextField_TextField,{autoComplete:"off",className:"input",disabled:isButtonDisabled,type:"text",onChange:e=>handleSearch(e.target.value),label:"Search metadata",variant:"standard"})}),/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"result",children:Results.map(function(data){return/*#__PURE__*/(0,jsx_runtime.jsxs)(Box_Box,{component:"section",onClick:e=>handleClick(e,data[0]),sx:{p:2,border:'1px dashed grey'},children:[/*#__PURE__*/(0,jsx_runtime.jsx)("div",{className:"boxName",children:/*#__PURE__*/(0,jsx_runtime.jsx)("span",{style:{textDecoration:"underline"},children:data[1]})}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"boxAttribute",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{style:{color:"#808080"},children:"Attribute:"})," ",data[2]]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Tooltip_Tooltip,{title:data[6],placement:"bottom-start",slotProps:{popper:{modifiers:[{name:'offset',options:{offset:[35,-14]}}]}},children:/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"boxValue",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{style:{color:"#808080"},children:"Value:"})," ",data[3],/*#__PURE__*/(0,jsx_runtime.jsx)("span",{style:{color:"#ff0000",fontWeight:"bold"},children:data[4]}),data[5]]})})]},data[0]);})})]})]});}/* harmony default export */ const src_App = (App_App);
...
/******/ })()
;
//# sourceMappingURL=main.3e05cff4.js.map
